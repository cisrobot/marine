...
# ─────────────── 설정 ───────────────
VIDEO_SAVE_DIR = '/media/marin/4cca4ad9-422b-4ad3-b582-3f9c402dd434/home/omo/videos/seg'  # 저장할 영상 디렉토리
MODEL_PATH = '/home/marin/marine/src/yolo_segmentation/models/best.pt'  # 학습된 YOLO11n-seg 모델 경로 (.pt)
...
class YoloSegmentationNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('input_topic', '/camera/d455_camera/color/image_raw')
